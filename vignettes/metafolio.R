...
## @knitr my-load-package, include=FALSE
library(metafolio)
set.seed(1)
...
## @knitr load-package, eval=FALSE
## library(metafolio)


## @knitr help, eval=FALSE
## vignette("metafolio")
## ?metafolio
...
## @knitr base-case-run, cache=FALSE
base1 <- meta_sim(n_pop = 10, env_params = arma_env_params,
  env_type = "arma", assess_freq = 5)


## @knitr plot-base-case-ts, fig.width=5, fig.height=6.5, out.width="4in", fig.cap="An example simulation with stationary environmental stochasticity and the base-case parameter values."
...
## @knitr env-eg, fig.width=5, fig.height=6, out.width="3in", fig.cap="Example environmental time series.", fig.pos="hpb"
...
## @knitr monte-carlo-eg-load, eval=TRUE, echo=FALSE
