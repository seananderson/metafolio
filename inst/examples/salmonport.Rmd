...
```{r fig.width=6, fig.height=3.75, fig.cap="Example Ricker curves for the minimum-variance metapopulation."}
...
```{r plot-weights-median, fig.width=4.2, fig.height=3.2, cache = FALSE, fig.cap="Median (solid line) and 25th and 75th quantiles of the weights across 40 minimum-variance portfolios. Just another way of looking at it."}
