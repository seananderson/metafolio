...
RELOAD_R_PACKAGE <- FALSE

if(RELOAD_R_PACKAGE) {
  document("../../")
  build("../../")
  if("metafolio" %in% loaded_packages()) 
    detach("package:metafolio", unload = TRUE)
  install.packages("~/Dropbox/ms/metafolio_0.1.tar.gz", type = "source", repos = NULL, INSTALL_opts = "--byte-compile")
  library(metafolio)
}
