...
```{r thermal-curves, fig.height=3.7, cache = FALSE, fig.width=5.0, fig.cap="Thermal tolerance curves for ten populations. Here, and throughout this document, I have used the same rainbow of colours to identify the salmon populations. The populations are arranged from blue (more productive with cooler temperatures) to red (more productive with warmer temperatures).\\label{fig:thermal-curves}"}
...
o <- meta_sim(env_params = list(amplitude = 2, ang_frequency = 0.2, phase = 0, mean_value = 16), sigma_v = 0.2, n_pop = 10, stray_fraction = 0.03, use_cache = FALSE)
#o<- meta_sim(b = rep(1000, 10), n_pop = 10)
plot_sim_ts(o, years_to_show = 60)
image(o$Est_b)
```
