...
set.seed(2)
eg1 <- meta_sim(sigma_v = 0.1)
set.seed(2)
eg2 <- meta_sim(env_params = list(amplitude = .000001, ang_frequency = 0.2, 
    phase = 0, mean_value = 16), sigma_v = 0.1)
set.seed(2)
eg3 <- meta_sim(stray_fraction = 0.00001, sigma_v = 0.1)
set.seed(2)
eg10 <- meta_sim(env_params = list(amplitude = 5.0001, ang_frequency = 0.2, 
    phase = 0, mean_value = 16), sigma_v = 0.1)
set.seed(2)
eg4 <- meta_sim(sigma_v = 0.000001)
set.seed(2)
eg5 <- meta_sim(sigma_v = 0.15)
set.seed(2)
eg7 <- meta_sim(max_a = rep(0.9, 10),sigma_v = 0.1)
set.seed(2)
eg8 <- meta_sim(max_a = rep(1.8, 10), sigma_v = 0.1)
set.seed(2)
eg9 <- meta_sim(stray_fraction = 0.1, sigma_v = 0.1)
...
#plot_sim_ts_simple(eg6, pal = col_pal, text = "No response diversity")
