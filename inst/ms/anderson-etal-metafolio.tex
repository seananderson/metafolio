...
% SOM:
\newlabel{f:stray}{{A1}{2}}
\newlabel{t:pars}{{B1}{3}}
\newlabel{f:eg-sens}{{C1}{4}}
\newlabel{f:eg-sp-arma-full}{{D1}{6}}
\newlabel{f:eg-sp-arma-half}{{D2}{7}}
\newlabel{f:eg-sp-linear-full}{{D3}{8}}
\newlabel{f:eg-sp-linear-half}{{D4}{9}}
\newlabel{f:eg-n-arma-two}{{D5}{10}}
\newlabel{f:eg-n-arma-sixteen}{{D6}{11}}
\newlabel{f:eg-n-linear-two}{{D7}{12}}
\newlabel{f:eg-n-linear-sixteen}{{D8}{13}}
\newlabel{f:eg-n-squeeze-two}{{D9}{14}}
\newlabel{f:eg-n-squeeze-twelve}{{D10}{15}}
...
\bigskip
\begin{code}
This document is an author preprint of the following published paper:
Anderson, S.C., J.W. Moore, M.M. McClure, N.K. Dulvy, A.B. Cooper. Portfolio
conservation of metapopulations under climate change. Ecological Applications.
http://doi.org/10.1890/14-0266.1
\end{code}
...
\begin{center}
\includegraphics[width=2.9in]{Fig2.pdf}
\end{center}
\bigskip
\noindent
...
\begin{center}
\includegraphics[width=4.0in]{Fig3.pdf}
\end{center}
\bigskip
\noindent
...
\begin{center}
\includegraphics[width=3in]{Fig6.pdf}
\end{center}
\bigskip
\noindent
